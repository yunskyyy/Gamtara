        ...
        {activeTab === "pesanan" && (
          <div className="bg-white border border-stone-300 rounded-none p-6 space-y-4">
            ...
            {lunasOrders.length === 0 ? (
              ...
              lunasOrders.map((ord) => (
                <div key={ord.orderId} className="p-4 bg-[#f4f2eb] border border-stone-300 rounded-none flex justify-between items-center text-xs">
                  <div>
                  ...
                  <Link href={`/chat/${ord.orderId}`} className="px-4 py-2 bg-[#1d3a28] text-white text-xs font-bold uppercase font-mono rounded-none flex items-center gap-1.5">
