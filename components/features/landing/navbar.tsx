        ...
        <nav className="pointer-events-auto flex items-center justify-between w-full max-w-5xl px-4 sm:px-8 py-1 bg-[#f4f2eb]/95 backdrop-blur-md border border-stone-300/80 rounded-sm shadow-md text-stone-900">
          ...
          <div className="flex items-center gap-3">
            {user ? (
              ...
              <button onClick={() => setIsAuthOpen(true)} className="bg-[#1d3a28] hover:bg-[#152a1b] text-stone-100 px-6 py-2.5 rounded-sm text-xs font-bold uppercase tracking-widest transition-all cursor-pointer shadow-sm">
                Masuk
              </button>
            )}
